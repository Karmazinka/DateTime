...
//Factory method - фабричный метод - когда экземпляр не создается вручную, а возвращается другим объектом
public class PoundOfButter {
    public static void main(String[] args) {
        ...
        System.out.println("A farmer sold a butter to backer");
        System.out.printf("The butter weight is %.2f pounds%n", butter.getWeight());
        System.out.println("The backer took the farmer to a court");
